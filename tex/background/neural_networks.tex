...
\begin{figure}[H]
    \centering
    \includegraphics[width=.5\linewidth]{bg_1D_conv}
    \caption{Example of a 1D convolution. A $1 \times 3$ kernel is shifted over a spectrum discretized at 9 wavelengths}
