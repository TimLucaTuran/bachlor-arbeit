...
But it is more efficient to average the changes and apply them at once after a small batch of training samples. This concludes the training of a Multilayer Perceptron but other Networks are trained in a similar manner. The excellent comprehensive explanation which was the basis for this section can be found here: \cite{backprop}.
