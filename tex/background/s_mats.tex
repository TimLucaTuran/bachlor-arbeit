...
and this would imply that the transmission from the front $t^f$ increases when the internal reflections of the system $r^b_1$ and $r^f_2$ increase which is the opposite of the behavior we expect. Redheffer \cite{Redheffer1960} studied these kind of systems in the 60s and gave an operator $\star$ which yields the combined $S$-matrix:
